...
public class OAuth2AuthenticationConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public JwtAccessTokenConverter jwtAccessTokenConverter() {
        ...
        converter.setSigningKey("just_a_test");
        return converter;
    }
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        clients.inMemory().withClient("justForFun").secret("123456").scopes("read", "update", "delete", "add").authorizedGrantTypes("password", "authorization_code", "refresh_token");
    }
}
